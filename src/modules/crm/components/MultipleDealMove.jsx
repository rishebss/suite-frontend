...
const MultipleDealMove = ({ isOpen, onClose, dealIds, currentPipelineId, onMoved }) => {
  ...
  const handleMove = async () => {
    ...
    try {
      ...
      setError(data?.detail || data?.error || data?.pipeline_id?.[0] || 'Failed to move deals.');
    } finally {
      setIsMoving(false);
    }
  };
...
export default MultipleDealMove;
